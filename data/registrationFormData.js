    ...
    inputs: [
        {
            ...
            error: "Invalid Email",
            fieldExampleData: "john.doe@outlook.com",
            step: 1
        },
        {
            id: 2,
            ...
            fieldExampleData: "John123 (English Alphabet)",
            step: 1,
        },
        {
            id: 3,
            ...
            fieldExampleData: "John!4151923 (English Alphabet)",
            step: 1,
        },
        {
            id: 4,
            ...
            fieldExampleData: "Match with the password field value",
            step: 1,
        },
        {
            id: 5,
            ...
            fieldExampleData: "John (English Alphabet)",
            step: 2,
        },
        {
            id: 6,
            ...
            fieldExampleData: "Doe (English Alphabet)",
            step: 2,
        },
        {
            id: 7,
        ...
        },
        {
            ...
            type: "date",
            validation: "",
            min: `${handleFormValues()?.registrationDobMin}-12-31`,
            max: `${handleFormValues()?.registrationDobMax}-12-31`,
        ...
        },
        {
            ...
            validation: "^[a-zA-Z]{2,30}$",
            error: "Invalid City",
            fieldExampleData: "Zagreb (English Alphabet)",
            step: 3,
        },
        {
            id: 11,
            ...
            fieldExampleData: "10000 (numbers only)",
            step: 3,
        },
        {
            id: 12,
            ...
            fieldExampleData: "Trg Eugena Kvaternika 4 (English Alphabet)",
            step: 3,
        },
        {
            id: 13,
            ...
            fieldExampleData: "4153-5422-4524-9520-1240 (Amex (4))",
            step: 4,
        },
        {
            id: 14,
            ...
            validation: "",
            options: handleFormValues()?.monthOptions,
            error: "Select Expire Month",
            step: 4,
        },
        {
            id: 15,
            ...
            validation: "",
            options: handleFormValues()?.creditCardExpireYearOptions,
            error: "Select Expire Year",
            step: 4,
        },
        {
            id: 16,
            ...
            fieldExampleData: "333 (Numbers Only)",
            step: 4,
        },
        {
            id: 17,
            ...
            validation: "",
            frontendSlug: "terms",
            content: `<h2>Website Terms of Use</h2>

<p>Version 1.0</p>

<p>The CydexPharm website located at www.cydex-pharm.com is a copyrighted work belonging to CydexPharm. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>
...
<p><strong>Cookies and Web Beacons.</strong> Like any other website, CydexPharm uses ‘cookies’. These cookies are used to store information including visitors’ preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users’ experience by customizing our web page content based on visitors’ browser type and/or other information.</p>
...
<p><strong>Notice Requirement and Informal Dispute Resolution.</strong> Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief.  A Notice to the Company should be sent to: Ulica Kresimira Branovica 2. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally.  If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding.  The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.</p>
...
<p>Address: Ulica Kresimira Branovica 2</p>
<p>Email: rene.levec@outlook.com</p>`,
            termsAcceptBtnLabel: "Accept",
            termsDeclineBtnLabel: "Decline",
            step: 5,
        }
    ],
    formError: "Form Entries are Invalid",
    successMessage: "RegistrationForm Successful",
    stepLabel: "Step",
    existsError: "User Already Registered With The Provided Email",
    singUpButtonLabel: "Sign Up",
    previousButtonLabel: "Previous",
    nextButtonLabel: "Next",
    loginRedirectLabel: "Already have an account?"
}